...
public class VolumeElevationDetectorAdapter extends MediaToolAdapter {
	...
	public VolumeElevationDetectorAdapter(int numberOfContinuousSections, double maxElevation, int granularity, long calibrationIntervalLength, ScreenShotsManager manager) {
	...
	public List<VideoSection> getLouderSections() {
		if (currentLouderSectionStart != null && manager.compareScreensForShotBoundary(currentLouderSectionStart)) {
